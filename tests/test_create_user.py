...
class TestCreateUser:
    ...
    def test_unsuccessfull_create_user_with_the_same_data(self, create_fake_user):
            with allure.step("формирование тела запроса"):
                payload = {
                    "email": create_fake_user["email"],
                    "password": create_fake_user["password"],
    ...
    def test_unsuccessfull_create_user_without_email(self, create_fake_user):
            with allure.step("формирование тела запроса"):
                payload = {
                    "password": create_fake_user["password"],
                    "name": create_fake_user["name"]
    ...
    def test_unsuccessfull_create_user_without_name(self, create_fake_user):
            with allure.step("формирование тела запроса"):
                payload = {
                    "email": create_fake_user["email"],
                    "password": create_fake_user["password"]
    ...
    def test_unsuccessfull_create_user_without_password(self, create_fake_user):
            with allure.step("формирование тела запроса"):
                payload = {
                    "email": create_fake_user["email"],
                    "name": create_fake_user["name"]
